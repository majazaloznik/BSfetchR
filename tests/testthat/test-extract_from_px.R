...
# Create test file
test_that("fetch_px can read Bank of Slovenia PX files", {
  # Skip if offline
  skip_if_offline()

  # Test standard case
  test_url <- "https://px.bsi.si/Resources/PX/Databases/serije_slo/10_denar_mfi/60_terj_mfi/I1_5AAS.px"
  result <- fetch_px(test_url)

  # Check basic properties of returned object
  expect_s3_class(result, "px")
